...
By the way, the operator is called the [**magrittr**](https://magrittr.tidyverse.org/) package, which is a central part of the Tidyverse. It provides a set of operators which make your code more readable.
