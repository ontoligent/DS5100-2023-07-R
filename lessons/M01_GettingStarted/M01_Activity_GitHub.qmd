...
![Alt text](https://www.tomasbeuzen.com/post/git-fork-branch-pull/image_2.png)
...
| **Pull Request**	| This is a request made to the owner of the original repo to pull in the changes you've made to your forked copy.	| This is done through GitHub's web interface. Read the [docs](https://docs.github.com/en/pull-requests)\ ![](https://canvas.its.virginia.edu/courses/58396/files/648662/preview). |
| **Fetch Upstream** | This refreshes the content of your forked repo with the content from the original repo. | This is done through GitHub's web interface. Read the [docs](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/syncing-a-fork).\ ![Diagram of sync fork button on GitHub](https://canvas.its.virginia.edu/courses/58396/files/648663/preview) | 

> Note: This is not the only pattern to use with Git. Here is another — [the Git Fork-Branch-Pull Workflow](https://www.tomasbeuzen.com/post/git-fork-branch-pull/)

Here is a visualization of the process:

![Diagram of common git workflow](https://canvas.its.virginia.edu/courses/58396/files/1005744/preview)
...
![](https://canvas.its.virginia.edu/courses/58396/files/648661/previewß)
...
![Image of pull request button on GitHub](https://canvas.its.virginia.edu/courses/58396/files/648662/preview)
