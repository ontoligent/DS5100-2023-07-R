...
::: {.callout-note}
If you would like to access your GitHub account without having to enter your credentials each time, follow [these instructions](../../topics/setting-up-ssh.qmd) to set an SSH key. You can create this on both your computer and Rivanna.
:::
