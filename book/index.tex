...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, bottomtitle=1mm, left=2mm, rightrule=.15mm, coltitle=black, arc=.35mm, opacitybacktitle=0.6, titlerule=0mm, colback=white, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, bottomrule=.15mm, toprule=.15mm, breakable, colframe=quarto-callout-important-color-frame, leftrule=.75mm]
