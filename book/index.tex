...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, toprule=.15mm, bottomrule=.15mm, titlerule=0mm, breakable, opacitybacktitle=0.6, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, coltitle=black, left=2mm, colback=white, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-important-color-frame, colbacktitle=quarto-callout-important-color!10!white, rightrule=.15mm, arc=.35mm, leftrule=.75mm]
